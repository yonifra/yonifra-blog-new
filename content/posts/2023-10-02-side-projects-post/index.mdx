---
title: Managing a side projects effectively
...
Decide which tasks are most important and focus on those first. You can use a task management app such as Todoist, Tick Tick or any other app that might be useful to you (these two are my favorites, and I use [Tick Tick](https://ticktick.com) as my go to To Do app)
...
If you have some extra vacation days, use them to work on your personal projects.
